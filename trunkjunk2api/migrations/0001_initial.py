# Generated by Django 4.1.6 on 2023-03-14 01:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bandana', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='joined_bandanas', to='trunkjunk2api.bandana')),
            ],
        ),
        migrations.CreateModel(
            name='BandanaColor',
